...
class TableViewController: UITableViewController {
    ...
    var areas = [
        Area(name:"A級特區", province:"上海", part:"華東", image:"xinzhuang", visited:false),
        Area(name:"B級特區", province:"甘肅", part:"西北", image:"qilihe", visited:false),
        Area(name:"C級特區", province:"福建", part:"東南", image:"youxi", visited:false),
        Area(name:"D級特區", province:"青海", part:"西北", image:"chengxi", visited:false),
        Area(name:"E級特區", province:"廣東", part:"華南", image:"baiyun", visited:false),
        Area(name:"F級特區", province:"福建", part:"東南", image:"shangjie", visited:false),
        Area(name:"G級特區", province:"黑龍江", part:"東北", image:"nangang", visited:false),
        Area(name:"H級特區", province:"山西", part:"華北", image:"yaodu", visited:false),
        Area(name:"I級特區", province:"四川", part:"西南", image:"wuhou", visited:false),
        Area(name:"J級特區", province:"廣西", part:"華南", image:"jinping", visited:false),
        Area(name:"K級特區", province:"湖南", part:"華中", image:"furong", visited:false)
    ]
